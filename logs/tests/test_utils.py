...
class UtilsGetDifferenceDaysHoursMinutesTests(TestCase):
    def test_difference_d_h_m_res1_greater_res2(self):
        res1, res2 = 50, 10
        self.assertEqual(get_difference_days_hrs_min(res1,res2), ["0d 0h 0m 50s", "+0d 0h 0m 40s"])

    def test_difference_d_h_m_res1_smaller_res2(self):
        res1, res2 = 10, 50
        self.assertEqual(get_difference_days_hrs_min(res1,res2), ["0d 0h 0m 10s", "-1d 23h 59m 20s"])


    def test_difference_d_h_m_res1_equal_res2(self):
        res1 = res2 = 50
        self.assertEqual(get_difference_days_hrs_min(res1, res2), ["0d 0h 0m 50s", "0d"])
